...
Shatter.prototype.spliceImage = function (polygons, img) {
    ...
    polygons.forEach(function (polygon) {
        ...
        var croppedImage;
        var tempBigImage = Shatter.prototype.getClippedImage(polygon, tempCtx, tempCanvas, img, function () {
            croppedImage = Shatter.prototype.getCroppedImage(polygon, tempBigImage, function (img) {
